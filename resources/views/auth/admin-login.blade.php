    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <form method="POST" action="{{ route('admin.login.submit') }}" class="md-float-material form-material">
                    @csrf
                    <div class="text-center">
                        <h2 style="color : white;">Pizza order system Admin</h2>
                    </div>
                    <div class="auth-box card">
                        <div class="card-block">
                            ...
                            <div class="form-group form-primary">
                                ...
                                <label class="float-label">Jouw email adres</label>
                            ...
                            <div class="form-group form-primary">
                                ...
                                @endif
                                <span class="form-bar"></span>
                                <label class="float-label">Wachtwoord</label>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="checkbox-fade fade-in-primary d-">
                                        <label>
                                            ...
                                            <span class="text-inverse">Onthoud mij</span>
                                        </label>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <p class="text-inverse text-left"><a href="{{ route('home') }}"><b>Terug naar website</b></a></p>
                                </div>
